...
<nav class="navbar navbar-expand-lg navbar sticky-top bg-success ">
        ...
        <div class="dropdown show">
            ...
            <ul class="dropdown-menu dropdown-menu-light w-100">
                <?php foreach ($categories as $category) { ?>
                    <li><a class="dropdown-item text-center bg-success border-danger h5 w-70 mt-2 p-2 border-redius text-light" href="categories.php?id=<?= $category['name'] ?>">
                            <ul> <?= $category['name'] ?></ul>
                        </a></li>
                <?php } ?>
            </ul>
