                        ...
                        <div class="card-body  text-center">
                            <div class=" w-100 ">
                                <div class=" px-2">
                                    ...
                                    <form action="./update.php?id=<?= $cat_Info['id'] ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <input type="file" name="picture"> <img src="./../../assets/uploads/<?= $cat_Info['picture'] ?>" alt="" height="40">
