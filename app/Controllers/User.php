...
class User
{
    ...
    //        if ($getdata == $value['email'] && $getdata2==$value['password']) {
    //         //echo "ok";
    //         header('Location: ./../products/index.php?success=Successfull Login!!');
    //        }else{
    //        // echo "no";
    //         header('Location: ./login.php?Error=UnSuccessfull Login!!');
    ...
    public function matching(string $name, string $password)
    {
   ...
   ,:u_contact)";
    ...
    public function update(array $data, int $id)
    {
        try {
            ...
            $sql1 = "SELECT * FROM user_info where id=$id";
