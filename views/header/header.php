...
<body>
    ...
    <div class="zindex-modal-backdrop side-navbar active-nav d-flex justify-content-between flex-wrap flex-column bg-dark" id="sidebar">
        <ul class="nav flex-column text-white w-100">
            ...
            <a href="./../../views/products/create_product.php">
                <li href="" class="nav-link">
                    <i class="bx bxs-dashboard"></i>
        ...
        <form action="./../header/logoutcontroller.php" method="POST">
            <span href="" class="nav-link h4 w-100 ">
                <a href="instagram.com"><i class="bx bxl-instagram-alt text-danger"></i></a>
                <a href="twiter.com"><i class="bx bxl-twitter px-2 mx-5 text-danger"></i></a>
                <a href="facebook.com"><i class="bx bxl-facebook text-danger mb-4"></i></a>
                <!-- <a href="./../forntend/index.php"> -->
                    <button type="submit" name="logout" class="btn btn-secondary w-100 my-2">Log Out</button>
                <!-- </a> -->
            </span>
        </form>
    </div>
    <nav class="navbar top-navbar navbar-light bg-dark m-0 px-5 sticky-top" style="height:80px ">
        <div class="input-group">
            <a href="index.php" class="nav-link h1 text-light ">
                Dashboard </br>
            </a>
