...
<body>
    ...
    <div class="container p-2">
        ...
        ?>
            ...
            <h4 class="text-light bg-success p-2 text-center"><?= $category['name'] ?></h4>
                            ...
                            <a href="show.php?id=<?= $Product['id'] ?>">
                                <div class="card" style="height: 400px;">
                                    <div class="card-body text-center">
                                        <img class="fs-card-img" src="../../assets/uploads/<?= $Product['picture'] ?>" alt=""  height="200px" width="180px">
                                      
                                        <h4><?= $Product['name'] ?></h4>
                                        <p><?= $Product['product_category'] ?> <br>
                                       <?= $Product['product_description'] ?></p>
                                        <h4 class="text-danger"><?= $Product['product_price'] ?> ৳</h4>
                        ...
                        <h6 class="text-primary text-centers curcor-pointer">
                            ...
                            foreach ($totalcart as $key => $value) {
                                ...
                                foreach ($value as $key => $values) {
                                    if ($values > 9) {
                            ?>
                                        <p class="text-danger text-center">9+</p>
                                    <?php
                                    }

                                    ?>
                                    <p class="text-danger text-center"><?= $values ?></p>
                            ...
                            ?>
                            Your Collection
                            <h3 class=" text-center"><a class="text-danger" href="productlist.php">+</a>
