            ...
            <form action="./add_to_buy.php" method="post">
                <div class="col-lg-12 col-sm-12">
                    <div class="row">
                        ...
                        <h1>Product Info</h1>
                        <h3 class="text-light bg-info p-2 text-center">Product Category : <?= $ProductToShow['product_category'] ?></h3>
                            ...
                            <div class="col-md-5">
                                ...
                                <h4>
                                    <p>Name: <?= $ProductToShow['product_category'] ?>
                                        <input type="hidden" name="name" value="<?= $ProductToShow['name'] ?>">
                                    </p>
                                </h4>
                                <h4>
                                ...
                                <h4>
                                    <p>Product Price : <?= $ProductToShow['product_price'] ?>
                                        <input type="hidden" name="product_price" value="<?= $ProductToShow['product_price'] ?>">
                                    </p>
                                </h4>
                                <h4>
